...
public class CafeteriaSystem {
    ...
    private final InvoiceFormatter printer;
    private int invoiceSeq = 1000;

    public CafeteriaSystem(InvoiceStore store, TaxCalculator taxCalculator, DiscountCalculator discountCalculator,
            InvoiceFormatter printer) {
        this.store = store;
