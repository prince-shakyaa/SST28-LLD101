 ...
 * Uses MarkerStyleFactory to obtain shared (flyweight) MarkerStyle instances.
 */
public class MapDataSource {
    ...
    public List<MapMarker> loadMarkers(int count) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            // Obtain shared flyweight from factory — no 'new MarkerStyle(...)' here
    ...
    public MarkerStyleFactory getFactory() {
        return factory;
    }
}
